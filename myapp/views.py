...
#Class based view for above Add product  [CreateView]
...
#Class based view for above Update product  [UpdateView]
...
#Class based view for above Delete product  [DeleteView]
